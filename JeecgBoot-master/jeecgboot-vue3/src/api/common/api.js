...
(function (Api) {
    ...
    Api["userList"] = "/sys/user/list";
    Api["roleList"] = "/sys/role/list";
    Api["queryDepartTreeSync"] = "/sys/sysDepart/queryDepartTreeSync";
    Api["queryTreeList"] = "/sys/sysDepart/queryTreeList";
    Api["loadTreeData"] = "/sys/category/loadTreeData";
    Api["loadDictItem"] = "/sys/category/loadDictItem/";
    Api["getDictItems"] = "/sys/dict/getDictItems/";
    Api["getTableList"] = "/sys/user/queryUserComponentData";
    Api["getCategoryData"] = "/sys/category/loadAllData";
})(Api || (Api = {}));
/**
 * 上传父路径
 */
