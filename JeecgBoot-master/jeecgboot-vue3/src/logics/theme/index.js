...
import { replaceStyleVariables, loadDarkThemeCss, replaceCssColors, darkCssIsReady, linkID, styleTagId, appendCssToDom, getStyleDom, } from '@rys-fe/vite-plugin-theme/es/client';
...
export async function changeTheme(color) {
    ...
    if (import.meta.env.PROD && appStore.getDarkMode === 'dark') {
        ...
        if (el?.href) {
            ...
            appendCssToDom(getStyleDom(styleTagId), processCss);
        }
    }
    else {
