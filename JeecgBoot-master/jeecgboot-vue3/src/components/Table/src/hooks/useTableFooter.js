...
export function useTableFooter(propsRef, slots, scrollRef, tableElRef, getDataSourceRef) {
        ...
        nextTick(() => {
            ...
            setTimeout(() => {
                useEventListener({
                    ...
                    name: 'scroll',
                    listener: () => {
                        const footerBodyDom = tableEl.$el.querySelector('.ant-table-footer .ant-table-content');
