...
var Api;
(function (Api) {
    Api["list"] = "/sys/comment/listByForm";
    Api["addText"] = "/sys/comment/addText";
    Api["deleteOne"] = "/sys/comment/deleteOne";
    Api["fileList"] = "/sys/comment/fileList";
    Api["logList"] = "/sys/dataLog/queryDataVerList";
    Api["queryById"] = "/sys/comment/queryById";
    Api["getFileViewDomain"] = "/sys/comment/getFileViewDomain";
})(Api || (Api = {}));
...
export function useCommentWithFile(props) {
    ...
    async function uploadOne(file) {
        ...
        return new Promise((resolve, reject) => {
            uploadMyFile(url, formData).then((res) => {
