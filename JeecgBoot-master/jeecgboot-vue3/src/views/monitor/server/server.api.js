...
var Api;
(function (Api) {
    Api["cpuCount"] = "/actuator/metrics/system.cpu.count";
    Api["cpuUsage"] = "/actuator/metrics/system.cpu.usage";
    Api["processStartTime"] = "/actuator/metrics/process.start.time";
    Api["processUptime"] = "/actuator/metrics/process.uptime";
    Api["processCpuUsage"] = "/actuator/metrics/process.cpu.usage";
    Api["jvmMemoryMax"] = "/actuator/metrics/jvm.memory.max";
    Api["jvmMemoryCommitted"] = "/actuator/metrics/jvm.memory.committed";
    Api["jvmMemoryUsed"] = "/actuator/metrics/jvm.memory.used";
    Api["jvmBufferMemoryUsed"] = "/actuator/metrics/jvm.buffer.memory.used";
    Api["jvmBufferCount"] = "/actuator/metrics/jvm.buffer.count";
    Api["jvmThreadsDaemon"] = "/actuator/metrics/jvm.threads.daemon";
    Api["jvmThreadsLive"] = "/actuator/metrics/jvm.threads.live";
    Api["jvmThreadsPeak"] = "/actuator/metrics/jvm.threads.peak";
    Api["jvmClassesLoaded"] = "/actuator/metrics/jvm.classes.loaded";
    Api["jvmClassesUnloaded"] = "/actuator/metrics/jvm.classes.unloaded";
    Api["jvmGcMemoryAllocated"] = "/actuator/metrics/jvm.gc.memory.allocated";
    Api["jvmGcMemoryPromoted"] = "/actuator/metrics/jvm.gc.memory.promoted";
    Api["jvmGcMaxDataSize"] = "/actuator/metrics/jvm.gc.max.data.size";
    Api["jvmGcLiveDataSize"] = "/actuator/metrics/jvm.gc.live.data.size";
    Api["jvmGcPause"] = "/actuator/metrics/jvm.gc.pause";
    Api["tomcatSessionsCreated"] = "/actuator/metrics/tomcat.sessions.created";
    Api["tomcatSessionsExpired"] = "/actuator/metrics/tomcat.sessions.expired";
    Api["tomcatSessionsActiveCurrent"] = "/actuator/metrics/tomcat.sessions.active.current";
    Api["tomcatSessionsActiveMax"] = "/actuator/metrics/tomcat.sessions.active.max";
    Api["tomcatSessionsRejected"] = "/actuator/metrics/tomcat.sessions.rejected";
    Api["memoryInfo"] = "/sys/actuator/memory/info";
})(Api || (Api = {}));
/**
 * 查询cpu数量
 */
