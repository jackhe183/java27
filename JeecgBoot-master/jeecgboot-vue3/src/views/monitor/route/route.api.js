...
(function (Api) {
    ...
    Api["deleteList"] = "/sys/gatewayRoute/deleteList";
    Api["save"] = "/sys/gatewayRoute/add";
    Api["edit"] = "/sys/gatewayRoute/updateAll";
    Api["delete"] = "/sys/gatewayRoute/delete";
    Api["copyRoute"] = "/sys/gatewayRoute/copyRoute";
    Api["batchPutRecycleBin"] = "/sys/gatewayRoute/putRecycleBin";
    Api["batchDeleteRecycleBin"] = "/sys/gatewayRoute/deleteRecycleBin";
})(Api || (Api = {}));
/**
 * 查询路由列表
 * @param params
