...
var Api;
(function (Api) {
    Api["listNoCareTenant"] = "/sys/user/listAll";
    ...
    Api["allRolesListNoByTenant"] = "/sys/role/queryallNoByTenant";
    ...
    Api["userQuitAgent"] = "/sys/user/userQuitAgent";
    Api["getQuitList"] = "/sys/user/getQuitList";
