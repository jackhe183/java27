...
var Api;
(function (Api) {
    Api["list"] = "/sys/permission/list";
    Api["save"] = "/sys/permission/add";
    Api["edit"] = "/sys/permission/edit";
    Api["delete"] = "/sys/permission/delete";
    Api["deleteBatch"] = "/sys/permission/deleteBatch";
    Api["ruleList"] = "/sys/permission/queryPermissionRule";
    Api["ruleSave"] = "/sys/permission/addPermissionRule";
    Api["ruleEdit"] = "/sys/permission/editPermissionRule";
    Api["ruleDelete"] = "/sys/permission/deletePermissionRule";
    Api["checkPermDuplication"] = "/sys/permission/checkPermDuplication";
})(Api || (Api = {}));
/**
 * 列表接口
 * @param params
