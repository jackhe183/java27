...
(function (ComponentTypes) {
    ComponentTypes["Default"] = "layouts/default/index";
    ComponentTypes["IFrame"] = "sys/iframe/FrameBlank";
...
export const dataRuleSearchFormSchema = [
    {
        field: 'ruleName',
        label: '规则名称',
        component: 'Input',
...
export const dataRuleFormSchema = [
    {
        label: 'id',
        field: 'id',
        component: 'Input',
