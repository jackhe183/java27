...
// 部门角色 columns
export const departRoleColumns = [
    {
        title: '部门角色名称',
        dataIndex: 'roleName',
        width: 100,
...
// 部门角色查询条件表单
export const departRoleSearchFormSchema = [
    {
        field: 'roleName',
        label: '部门角色名称',
        component: 'Input',
...
// 部门角色弹窗form表单
export const departRoleModalFormSchema = [
    {
        label: 'id',
        field: 'id',
        component: 'Input',
...
// 基本信息form
export function useBaseInfoForm(treeData) {
    const descItems = [
        {
            field: 'departName',
            label: '机构名称',
...
//# sourceMappingURL=depart.user.data.js.map