...
//邀请用户搜索表单
export const userSearchFormSchema = [
    {
        field: 'username',
        label: '账号',
        component: 'Input',
...
//产品包表单
export const packMenuFormSchema = [
    {
        field: 'packName',
        label: '产品包名称',
        component: 'Input',
...
//租户回收站搜索表单
export const searchRecycleFormSchema = [
    {
        field: 'name',
        label: '租户名称',
        component: 'Input',
...
//产品包用户列表
export const tenantPackUserColumns = [
    {
        title: '用户',
        dataIndex: 'realname',
        width: 200,
